...
function defineEarthfile(hljs) {
  ...
  const EARTHLY_COMMAND = {
    className: "keyword",
    begin:
      /\b(?:SAVE ARTIFACT|SAVE IMAGE|GIT CLONE|WITH DOCKER|FROM DOCKERFILE|ELSE IF|VERSION|LOCALLY|BUILD|WAIT|FUNCTION|COMMAND|IMPORT|CACHE|HOST|PROJECT|ARG|LET|SET|FOR|IF|ELSE|END|TRY|CATCH|FINALLY|DO)\b/,
    relevance: 10,
  };
